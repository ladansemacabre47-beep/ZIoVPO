...
public class SignatureHistoryResponse {
    ...
    public SignatureHistoryResponse(Long historyId, UUID signatureId,
                                    Instant versionCreatedAt, String threatName,
                                    String firstBytesHex, String remainderHashHex,
                                    long remainderLength, String fileType,
                                    long offsetStart, long offsetEnd,
