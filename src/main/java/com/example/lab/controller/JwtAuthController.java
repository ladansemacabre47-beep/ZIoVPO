...
import com.example.lab.dto.RefreshRequest;
import com.example.lab.dto.TokenResponse;
import com.example.lab.entity.UserEntity;
import com.example.lab.entity.UserSession;
import com.example.lab.service.UserSessionService;
...
public class JwtAuthController {
    ...
    public ResponseEntity<?> refresh(@RequestBody RefreshRequest req, HttpServletRequest httpReq) {
        ...
        if (session.getStatus() != com.example.lab.entity.SessionStatus.ACTIVE) {
